...
html=html.replace('<script type="module" src="./app.js"></script>','<script>globalThis.IPOD_EOE_CATALOG='+catalog_json.replace('</','<\\/')+';window.IPOD_MODEL_DATA="'+model+'";</script><script type="module">'+script.replace('</script','<\\/script')+'</script>')
